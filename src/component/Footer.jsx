...
import facebook from "../../src/assets/images/facebook 1.png";
import gmail from "../../src/assets/images/gmail 1.png";
import phone from "../../src/assets/images/phone 1.png";
import email from "../../src/assets/images/email 1.png";
    ...
    <>
      <footer>
        <div className="container-fluid mt-5">
          <div className="text-center we_are_here">We’re here for you</div>
        ...
        <div className="container-fluid mb-5 mt-5 backgroud-footer">
          <div className="row">
            ...
            <div className="col-md-4 mt-5 form">
              ...
              />
 <img src={email} alt="Responsive"  width="55vw" height="70vh" />
 </div>
          </div>
        </div>
      </footer>
